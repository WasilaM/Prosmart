                                        ...
                                        <form method="post" action="{{ route('service.store') }}"
                                            ...
                                            <div class="portlet-body">
                                                <div class="tabbable-bordered">
                                                        ...
                                                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                            <li>
                                                                <a rel="alternate" hreflang="{{ $localeCode }}"
                                                                    data-toggle="tab" href="#tab_lang_{{ $localeCode }}">
                                                                    {{ $properties['native'] }}
                                                                </a>
                                                            </li>
                                                        @endforeach
                                                    ...
                                                    <div class="tab-content">
                                                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                            <div class="tab-pane fade @if ($loop->
                                                                first) active in @endif "
                                                                id="tab_lang_{{ $localeCode }}">
                                                                @php
                                                                ...
                                                                <div class="form-group">
                                                                    <label
                                                                        class="col-md-2 control-label">{{ __('Title') }}:
                                                                ...
                                                                <div class="form-group">
                                                                    <label
                                                                        class="col-md-2 control-label">{{ __('Description') }}:
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control" id="placeTextarea"
                                                                            rows="3"
                                                                            name="description[{{ $localeCode }}]">{{ old('description') }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            id="placeTextarea2" rows="3"
                                                                            name="importance[{{ $localeCode }}]">{{ old('importance') }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label
                                                                        class="col-md-2 control-label">{{ __('Meta Data') }}:
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            name="metaData[{{ $localeCode }}]">{{ old('metaData') }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label
                                                                        class="col-md-2 control-label">{{ __('Meta Description') }}:
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            name="metaDescription[{{ $localeCode }}]">{{ old('metaDescription') }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input type="text" class="form-control input-large" name="keywords[{{ $localeCode }}]" value="{{ old('keywords') }}" data-role="tagsinput">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @php
