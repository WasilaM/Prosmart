              ...
              <div class="tab-pane active" id="tab_0">
                <div class="portlet box green">
                  <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('workDone.update', $work->id)}}" enctype="multipart/form-data" class="form-horizontal">
                      @method('put')
                      @csrf
                      <input type="hidden" class="form-control input-circle" name="id" value="{{$work->id}}">
                      <div class="portlet-body">
                        <div class="tabbable-bordered">
                          ...
                          <div class="tab-content">
                            <div class="tab-pane fade active in " id="tab_lang_content">
                              ...
                              <div class="form-group">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="{{asset($work->image_url)}}"/> </div>
