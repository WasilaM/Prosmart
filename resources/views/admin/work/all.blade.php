        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <a href="{{route('workDone.create')}}" class="btn btn-outline-primary">Create</a>
                </div>
            </div>
        </div>
        <!-- END PAGE BAR -->
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{$item->title}} </td>
                                        <td>
                                            <form method="POST" action="{{route('statusWorkDone',$item->id)}}">
                                            @method('PUT')
                                            @csrf
                                        ...
                                        <td>
                                            <a href="{{route('workDone.edit', $item->id)}}" class="btn btn-primary">Edit</a>
                                        </td>
                                        <td>
                                            <form method="POST" action="{{route('workDone.destroy', $item->id)}}">
                                                @method('delete')
                                                @csrf
