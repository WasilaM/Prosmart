                                                        ...
                                                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                            <div class="tab-pane fade @if ($loop->
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="{{ $project->translate($localeCode)['title'] }}">
                                                                    </div>
                                                                    @error('title')
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control" id="placeTextarea"
                                                                            rows="3"
                                                                            name="description[{{ $localeCode }}]">{{ $project->translate($localeCode)['description'] }}</textarea>
                                                                    </div>
                                                                    @error('description')
                                                                        <div class="alert alert-danger">{{ $message }}
                                                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            name="metaData[{{ $localeCode }}]">{{ $project->translate($localeCode)['metaData'] }}</textarea>
                                                                    </div>
                                                                    @error('title')
                                                                        <div class="alert alert-danger">{{ $message }}
                                                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            name="metaDescription[{{ $localeCode }}]">{{ $project->translate($localeCode)['metaDescription'] }}</textarea>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label
                                                                        class="col-md-2 control-label">{{ __('Meta Keywords') }}:
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            name="keywords[{{ $localeCode }}]">{{ $project->translate($localeCode)['keywords'] }}</textarea>
                                                                    </div>
                                                                    @error('keywords')
                                                                        <div class="alert alert-danger">{{ $message }}
                                                                        </div>
                                                        ...
                                                        <div class="tab-pane" id="tab_banner">
                                                            <div class="form-group">
                                                                <div class="fileinput fileinput-new"
                                                                    ...
                                                                    <div class="fileinput-new thumbnail"
                                                                        style="width: 200px; height: 150px;">
                                                                        <img src="{{ asset($project->banner_url) }}" />
                                                                    </div>
                                                                    <div class="fileinput-preview fileinput-exists thumbnail"
                                                                        style="max-width: 200px; max-height: 150px;"> </div>
                                                                    <div>
