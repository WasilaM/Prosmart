...
@section('title', 'Documentary Films')
                                                    ...
                                                    <div class="tab-content">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input type="text" class="form-control"
                                                                            name="data[address][{{ $localeCode }}]"
                                                                            value="{{ @$setting->data['data']['address'][$localeCode] }}">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            id="placeTextarea-{{ $localeCode }}" rows="3"
                                                                            name="data[description][{{ $localeCode }}]">{{ @$setting->data['data']['description'][$localeCode] }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label
                                                                        class="col-md-2 control-label">{{ __('Importants') }}:
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control"
                                                                            id="placeTextarea2-{{ $localeCode }}" rows="3"
                                                                            name="data[importants][{{ $localeCode }}]">{{ @$setting->data['data']['importants'][$localeCode] }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @php
                                                        ...
                                                        <div class="tab-pane" id="tab_video">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input type="text" class="form-control"
                                                                        name="data[video][{{ $localeCode }}]"
                                                                        value="{{ @$setting->data['data']['video'][$localeCode] }}">
                                                                </div>
                                                            </div>
                                                        </div>
...
@section('script')
    ...
    <script>
        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
            ...
            CKEDITOR.replace( 'placeTextarea2-{{ $localeCode }}' );
        @endforeach
