                                            ...
                                            <div class="portlet-body">
                                                <div class="tabbable-bordered">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <li>
                                                            <a href="#tab_video" data-toggle="tab"> Documentry Film </a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade @if($errors->has('title','metaData') || $errors->isempty()) active in @endif" id="tab_content">
                                                        ...
                                                        <div class="tab-pane fade @if($errors->has('image')) active in @endif" id="tab_images">
                                                            <div class="form-group">
                                                                <div class="fileinput fileinput-new"
                                                                    data-provides="fileinput">
                                                                    <div class="fileinput-new thumbnail"
                                                                        style="width: 200px; height: 150px;">
                                                                        <img src="{{ asset($client->image_url) }}" />
                                                                    </div>
